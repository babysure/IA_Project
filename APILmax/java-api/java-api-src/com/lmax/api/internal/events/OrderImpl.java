...
public class OrderImpl implements Order
{
    ...
    private final boolean trailingStopLoss;
    private final FixedPointNumber stopProfitOffset;
    private final FixedPointNumber commission;
    private final TimeInForce timeInForce;

    public OrderImpl(final String originalInstructionId, final String instructionId, final String orderId, final long instrumentId, final long accountId, final OrderType orderType,
                     ...
                     final FixedPointNumber stopReferencePrice, final FixedPointNumber stopLossOffset, final boolean trailingStopLoss, final FixedPointNumber stopProfitOffset,
                     final FixedPointNumber commission)
    {
