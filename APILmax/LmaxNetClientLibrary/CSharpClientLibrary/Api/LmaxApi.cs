...
namespace Com.Lmax.Api
{
    ...
    public class LmaxApi
    {
        ...
        /// For testing: 'https://web-order.london-demo.lmax.com' and production: 'https://api.lmaxtrader.com'.
        /// </summary>
        /// <param name="urlBase">
        ...
        public LmaxApi(String urlBase, String clientIdentifier) :
            this(urlBase, new HttpInvoker(new LmaxApiOptions(clientIdentifier)), new SaxParser())
        {
        }
        ...
        public LmaxApi(String urlBase, LmaxApiOptions apiOptions) :
