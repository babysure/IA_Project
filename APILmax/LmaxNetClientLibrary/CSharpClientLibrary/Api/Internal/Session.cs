...
namespace Com.Lmax.Api.Internal
{
    ...
    public class Session : ISession
    {
        ...
        public void PlaceClosingOrder(ClosingOrderSpecification closingOrderSpecification, OnInstructionResponse instructionCallback, OnFailure failureCallback)
        {
            OrderResponseHandler handler = new OrderResponseHandler();
            SendRequest(closingOrderSpecification, handler, delegate { instructionCallback(handler.InstructionId); }, failureCallback);
        }

        public void PlaceStopOrder(Com.Lmax.Api.Order.StopOrderSpecification stopOrderSpecification, OnInstructionResponse instructionCallback, OnFailure failureCallback)
        {
            OrderResponseHandler handler = new OrderResponseHandler();
        ...
        public void Start()
        {
            ...
            do
            {
                try
                {
                    ...
                    bool wasStoppedAlready = Thread.VolatileRead(ref _volatileRunFlag) == Stopped;
