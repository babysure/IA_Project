...
namespace Com.Lmax.Api
{
    ...
    public interface ISession
    {
        ...
        /// <param name="instructionCallback">A <see cref="OnInstructionResponse"/> called when an order has
        /// been validated and passed onto the broker.</param>
        /// <param name="failureCallback">A <see cref="OnFailure"/> called if the call to close the order has failed.</param>
        void PlaceClosingOrder(ClosingOrderSpecification closingOrderSpecification, OnInstructionResponse instructionCallback, OnFailure failureCallback);
        ...
        /// <summary>
        /// Check if the session is running the event processing loop.
        /// </summary>
        bool IsRunning { get; }
