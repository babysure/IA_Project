...
namespace Com.Lmax.Api.Order
{
    ...
    public class Order : IEquatable<Order>
    {
        ...
        public Order(
                string instructionId, string originalInstructionId, string orderId, long instrumentId, long accountId, decimal? price, decimal quantity, decimal filledQuantity,
        ...
        /// <summary>
        /// Get the id of the original instruction that this state refers to.  Useful
        /// for tracking cancels to their original order.  For a new order this will
        /// be the same as the instructionId.
        /// </summary>
        ...
        {
            get { return _orderType == OrderType.LIMIT ? _price : null; }
        }
        ...
        {
            get { return _orderType == OrderType.STOP_ORDER ? _price : null; }
        }
        ...
        public bool Equals(Order other)
        {
            ...
            return other._instructionId == _instructionId && 
                   Equals(other._originalInstructionId, _originalInstructionId) &&
                   Equals(other._orderId, _orderId) && other._instrumentId == _instrumentId && 
        ...
        {
            return string.Format("Order{{InstructionId: {0}, OriginalInstructionId: {13}, OrderId: {1}, InstrumentId: {2}, AccountId: {3}, Price: {4}, StopLossOffset: {5}, StopProfitOffset: {6}, " +
                                 ...
                                 _filledQuantity, _cancelledQuantity, _orderType, _commission, _originalInstructionId);
        }
    }
