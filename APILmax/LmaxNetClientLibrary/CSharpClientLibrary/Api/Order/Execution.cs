...
namespace Com.Lmax.Api.Order
{
    ...
    public class Execution
    {
        ...
        private readonly string _encodedExecutionId;
        ...
        /// <summary>
        /// Get execution id of the trade, that can be correlated with the UI and broker FIX.
        /// </summary>
        public string EncodedExecutionId
        {
            get { return _encodedExecutionId; }
        }
