...
namespace Com.Lmax.Api
{
    public class TradeInsideTheSpreadBot
    {
        ...
        {
            string instructionId = instructionRejected.InstructionId;
        ...
        {
            string originalInstructionId = orderTracker.InstructionId;
        ...
        private string NextInstructionId()
        {
            ...
            return Interlocked.Increment(ref _nextInstructionId).ToString();
    ...
    {
        private string _instructionId = null;
        private string _cancelInstructionId = null;
        ...
        public string CancelInstructionId
        {
